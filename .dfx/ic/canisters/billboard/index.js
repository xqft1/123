...
import { idlFactory } from './billboard.did.js';
export { idlFactory } from './billboard.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BILLBOARD;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./billboard.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the billboard canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./billboard.did.js")._SERVICE>}
 */
export const billboard = createActor(canisterId);
